...
<div id="vote" class="wrap">
	...
	<c:forEach items="${sessionScope.list }" var="item">
		<li  class="odd" >
			<h4>				
				<a href="Subject!update.action?title=${item.title }&userName=${item.userName }">${item.title }</a>
			</h4>
			<div class="edit"><a href="Subject!update.action?title=${item.title }&userName=${item.userName }">维护</a></div>
